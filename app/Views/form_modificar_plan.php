...
<h1>Modificar Plan</h1>
 ...
 -->
    ...
    <div class="login">
        ...
        <form class="login-container" action="<?= base_url('modificar_plan') ?>" method="post">

            <p>

                <label for="txtPlanId" class="form-label">ID:</label>
                <input type="number" id="txtPlanId" name="txtPlanId" class="form-control" autocomplete="off" placeholder="Ingrese el código del ID" value="<?= $datos['plan_id']; ?>" readonly>
            ...
            <p>
                ...
                <label for="txtNombre" class="form-label">Nombre:</label>
                <input type="text" id="txtNombre" name="txtNombre" class="form-control" autocomplete="off" placeholder="Ingrese el nombre del plan" value="<?= $datos['nombre']; ?>">

            </p>

            <p>
                <label for="txtPagoMensual" class="form-label">Pago mensual</label>
                <input type="number" id="txtPagoMensual" name="txtPagoMensual" class="form-control" autocomplete="off" placeholder="Ingrese el pago mensual" value="<?= $datos['pago_mensual']; ?>">
            </p>

            <p>

                <label for="txtCantidadMinutos" class="form-label">Cantidad de minutos</label>
                <input type="text" id="txtCantidadMinutos" name="txtCantidadMinutos" class="form-control" autocomplete="off" placeholder="Ingrese la cantidad de minutos" value="<?= $datos['cantidad_minutos']; ?>">
            ...
            <p>
                ...
                <label for="txtCantidadMensajes" class="form-label">Cantidad de mensajes</label>
                <input type="text" id="txtCantidadMensajes" name="txtCantidadMensajes" class="form-control" autocomplete="off" placeholder="Ingrese la cantidad de mensajes" value="<?= $datos['cantidad_mensajes']; ?>">
