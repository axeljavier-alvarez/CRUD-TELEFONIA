...
<div class="login">
        ...
        <form class="login-container" action="<?= base_url('modificar_cliente') ?>" method="post">
            ...
            <p>
                ...
                <input type="number" id="txtId" name="txtId" class="form-control" autocomplete="off" value="<?= $datos['cliente_id']; ?>" readonly>
            </p>
            ...
            <p>
                ...
                <input type="text" id="txtCorreo" name="txtCorreo" class="form-control" autocomplete="off" value="<?= $datos['correo_electronico']; ?>">
            </p>

            <p>
            <label for="txtCalleAvenida" class="form-label">Calle avenida:</label>
            <input type="text" id="txtCalleAvenida" name="txtCalleAvenida" class="form-control" autocomplete="off" value="<?= $datos['calle_avenida']; ?>">

            </p>

            <p>
            <label for="txtNumeroCasa" class="form-label">Número de casa:</label>
            <input type="text" id="txtNumeroCasa" name="txtNumeroCasa" class="form-control" autocomplete="off" value="<?= $datos['no_casa']; ?>">
            </p>

            <p>
            <label for="txtZona" class="form-label">Zona:</label>
            <input type="text" id="txtZona" name="txtZona" class="form-control" autocomplete="off" value="<?= $datos['zona']; ?>">
            </p>
